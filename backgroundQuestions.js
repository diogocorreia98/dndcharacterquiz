const step3pt = {
  ...
  combos: {
    'Constitution + Intelligence': ['Criminal','Merchant','Sage'],
    'Dexterity + Intelligence': ['Artisan','Criminal','Scribe'],
    'Constitution + Dexterity': ['Charlatan','Criminal','Guide','Soldier'],
    ...
    'Constitution + Strength': ['Farmer','Soldier'],
    ...
    'Dexterity + Wisdom': ['Guide','Sailor','Scribe','Wayfarer'],
    'Constitution + Wisdom': ['Farmer','Guide','Hermit','Sage'],
    'Wisdom': ['Acolyte','Farmer','Guard','Guide','Hermit','Sage','Sailor','Scribe','Wayfarer'],
    'Intelligence + Strength': ['Artisan','Guard','Noble'],
    'Charisma + Strength': ['Entertainer','Noble'],
    'Strength + Wisdom': ['Farmer','Guard','Sailor'],

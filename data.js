...
const data = {
  ...
  const speciesInfo = {
    pt: {
      ...
      'Black Dragonborn':'Descendente de dragão negro, cospe ácido e resiste a ele.',
      'Blue Dragonborn':'Descendente de dragão azul, exala relâmpagos e resiste a eles.',
      'Brass Dragonborn':'Descendente de dragão de latão, usa sopro de fogo e adora conversar.',
      'Bronze Dragonborn':'Descendente de dragão de bronze, exala relâmpagos com nobreza.',
      'Copper Dragonborn':'Descendente de dragão de cobre, cospe ácido e gosta de travessuras.',
      'Gold Dragonborn':'Descendente de dragão dourado, liberta fogo poderoso com majestade.',
      'Green Dragonborn':'Descendente de dragão verde, exala veneno astuto.',
      'Red Dragonborn':'Descendente de dragão vermelho, domina o fogo mais intenso.',
      'Silver Dragonborn':'Descendente de dragão prateado, exala frio com bondade.',
      'White Dragonborn':'Descendente de dragão branco, sopra gelo brutal.',
      ...
      'Drow Elf':'Elfo drow de pele escura e magia inata do Subterrâneo.',
      'High Elf':'Alto elfo com sangue arcano e tradições refinadas.',
      'Wood Elf':'Elfo da floresta, ágil e furtivo.',
      ...
      'Forest Gnome':'Gnomo da floresta ligado à magia natural e aos animais.',
      'Rock Gnome':'Gnomo das rochas, inventor de pequenas engenhocas.',
      ...
      'Cloud Goliath':'Goliath das nuvens que se teleporta a curtas distâncias.',
      'Fire Goliath':'Goliath do fogo que incendeia os ataques.',
      'Frost Goliath':'Goliath da geada que congela inimigos.',
      'Hill Goliath':'Goliath das colinas que derruba adversários com força.',
      'Stone Goliath':'Goliath de pedra de grande resistência.',
      'Storm Goliath':'Goliath da tempestade que retalia com trovão.',
      ...
      'Abyssal Tiefling':'Tiefling abissal resistente a veneno e dotado de magia demoníaca.',
      'Chthonic Tiefling':'Tiefling ctónico que resiste a energia necrótica e usa feitiços sombrios.',
      'Infernal Tiefling':'Tiefling infernal resistente ao fogo e aos poderes diabólicos.',
      ...
      'Autumn Eladrin':'Eladrin do outono que encanta criaturas após teleportar.',
      'Winter Eladrin':'Eladrin do inverno que amedronta inimigos com seu passo feérico.',
      'Spring Eladrin':'Eladrin da primavera que teletransporta aliados.',
      'Summer Eladrin':'Eladrin do verão que queima inimigos ao se mover magicamente.',
      ...
      'Air Genasi':'Genasi do ar descendente de djinn, resistente a relâmpagos.',
      'Earth Genasi':'Genasi da terra que ignora terreno difícil.',
      'Fire Genasi':'Genasi do fogo, envolto em chamas e resistente a elas.',
      'Water Genasi':'Genasi da água, respira debaixo de água e domina correntes.',
      ...
      'Marionette Geppettin':'Boneco vivo de madeira que não precisa dormir, muitas vezes artista ou espião.',
      'Bisque Geppettin':'Boneca de porcelana viva e elegante que não precisa comer nem dormir.',
      'Plushie Geppettin':'Boneco de peluche animado e resistente que dispensa alimentação e descanso.',
      ...
      'Spring Mandrake':'Mandrágora da primavera que puxa inimigos voadores ao solo.',
      'Summer Mandrake':'Mandrágora do verão que move adversários com vinhas.',
      'Autumn Mandrake':'Mandrágora do outono que prende vários alvos de uma vez.',
      'Winter Mandrake':'Mandrágora do inverno que causa rajadas de frio.',
      ...
      'Beasthide Shifter':'Metamorfo couraça bestial que endurece a pele ao transformar-se.',
      'Longtooth Shifter':'Metamorfo dente longo que morde ferozmente em combate.',
      'Swiftstride Shifter':'Metamorfo passo veloz que se move rapidamente entre inimigos.',
      'Wildhunt Shifter':'Metamorfo caça selvagem com sentidos aguçados e difícil de surpreender.',

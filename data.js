...
const nameMap = {
  pt: {
    ...
    subclasses: {
      'Path of the Berserker':'Bárbaro do Caminho do Berserker',
      'Path of the Wild Heart':'Bárbaro do Caminho do Coração Selvagem',
      'Path of the World Tree':'Bárbaro do Caminho da Árvore do Mundo',
      'Path of the Zealot':'Bárbaro do Caminho do Fanático',
      'Path of the Muscle Wizard':'Bárbaro do Caminho do Mago Musculado',
      'College of Dance':'Bardo do Colégio da Dança',
      'College of Glamour':'Bardo do Colégio do Deslumbramento',
      'College of Lore':'Bardo do Colégio do Conhecimento',
      'College of Valor':'Bardo do Colégio da Bravura',
      'Life Domain':'Clérigo do Domínio da Vida',
      'Light Domain':'Clérigo do Domínio da Luz',
      'Trickery Domain':'Clérigo do Domínio da Trapaça',
      'War Domain':'Clérigo do Domínio da Guerra',
      'Circle of the Land':'Druida do Círculo da Terra',
      'Circle of the Moon':'Druida do Círculo da Lua',
      'Circle of the Sea':'Druida do Círculo do Mar',
      'Circle of Stars':'Druida do Círculo das Estrelas',
      'Champion':'Guerreiro Campeão',
      'Battle Master':'Guerreiro Mestre de Batalha',
      'Eldritch Knight':'Guerreiro Cavaleiro Místico',
      'Psi Warrior':'Guerreiro Cavaleiro Psiónico',
      Dungeoneer:'Guerreiro Explorador de Masmorras',
      'Way of the Open Hand':'Monge do Caminho da Mão Aberta',
      'Way of Shadow':'Monge do Caminho da Sombra',
      'Way of the Elements':'Monge do Caminho dos Elementos',
      'Way of Mercy':'Monge do Caminho da Misericórdia',
      'Warrior of the Street':'Monge Lutador das Ruas',
      'Oath of Devotion':'Paladino do Juramento da Devoção',
      'Oath of Glory':'Paladino do Juramento da Glória',
      'Oath of the Ancients':'Paladino do Juramento dos Ancestrais',
      'Oath of Vengeance':'Paladino do Juramento da Vingança',
      'Oath of Revelry':'Paladino do Juramento da Celebração',
      'Beast Master':'Patrulheiro Mestre das Feras',
      'Fey Wanderer':'Patrulheiro Viajante Feérico',
      'Gloom Stalker':'Patrulheiro das Sombras',
      'Hunter':'Patrulheiro Caçador',
      'Arachnoid Stalker':'Ladino Aracnídeo',
      'Arcane Trickster':'Ladino Trapaceiro Arcano',
      'Assassin':'Ladino Assassino',
      'Soulknife':'Ladino da Lâmina Psíquica',
      Thief:'Ladino Ladrão',
      'Aberrant Sorcery':'Feiticeiro da Magia Aberrante',
      'Clockwork Sorcery':'Feiticeiro da Magia Mecânica',
      'Draconic Sorcery':'Feiticeiro da Magia Dracónica',
      'Wild Magic':'Feiticeiro da Magia Caótica',
      'Archfey Patron':'Bruxo com Patrono Arqui-feérico',
      'Celestial Patron':'Bruxo com Patrono Celestial',
      'Fiend Patron':'Bruxo com Patrono Infernal',
      'Future You':'Bruxo com A Sua Versão Futura como Patrono',
      'Great Old One Patron':'Bruxo com Patrono Grande Ancião',
      Abjurer:'Mago Abjurador',
      Diviner:'Mago Divinador',
      Evoker:'Mago Evocador',
      Illusionist:'Mago Ilusionista'
    }
  },

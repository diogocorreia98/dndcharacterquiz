...
const data = {
  ...
  const speciesInfo = {
    pt: {
      ...
      'Spring Mandrake':'Com uma aparência de jovem árvore, os Spring Mandrakes florescem na primavera. Sua magia natural está ligada ao crescimento e à cura, e seus poderes são amplificados sob a luz do sol, permitindo-lhes crescer rapidamente.',
      'Summer Mandrake':'Os Summer Mandrakes são vigorosos e cheios de energia, com troncos robustos e folhas vibrantes. Sua magia está ligada à vitalidade, permitindo-lhes curar rapidamente e manipular a natureza com grande força.',
      'Autumn Mandrake':'Com a aparência de uma árvore envelhecida e folhas douradas, os Autumn Mandrakes possuem uma sabedoria antiga. Eles são capazes de afetar várias criaturas ao mesmo tempo com suas habilidades naturais e manipular o ambiente à sua volta.',
      'Winter Mandrake':'Com uma aparência gélida, os Winter Mandrakes possuem habilidades que imitam o frio e a neve. Seus poderes são congelantes, causando dano com o toque do inverno e manipulando a área ao redor com magia gelada.',

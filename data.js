...
const data = {
  ...
  const subclassInfo = {
      pt: {
        'Path of the Berserker': 'Bárbaros encarnam força bruta e emoção primal. O Caminho do Berserker liberta violência incontrolável e resiste a interferências mentais, tornando-te uma força brutal da natureza.',
        'Path of the Wild Heart': 'Bárbaros ligados a espíritos animais. Ruges como urso, águia ou lobo e ganhas garras ou asas selvagens.',
        'Path of the World Tree': 'Segues a Árvore do Mundo, canalizando Yggdrasil para curar, agarrar inimigos e teletransportar-te pelo campo de batalha.',
        'Path of the Zealot': 'A tua fúria converte-se em poder divino. Esmaga com ira sagrada e desafias a morte para continuar a lutar.',
        'Path of the Muscle Wizard': 'Finges ser mago mas resolves tudo à pancada, lançando “feitiços” como murros e intimidando com força mágica.',
        'College of Dance': 'Bardos dançarinos lutam com passos graciosos, inspirando aliados e esquivando-se do perigo em giros rápidos.',
        'College of Glamour': 'Usas encanto feérico para deslumbrar inimigos e elevar aliados com a majestade da Feywild.',
        'College of Lore': 'Colecionas segredos e aprendes qualquer magia, desmontando ataques com a tua sagacidade.',
        'College of Valor': 'Cantas lendas e lideras na linha da frente, combinando espada e magia inspiradora.',
        'Life Domain': 'O Domínio da Vida torna-te o curandeiro supremo, fortalecendo cada magia de cura.',
        'Light Domain': 'Empunhas luz abrasadora para revelar e queimar as trevas com a fúria do sol.',
        'Trickery Domain': 'Abençoas com furtividade e ilusão, espalhando caos sagrado entre os inimigos.',
        'War Domain': 'Avanças para a batalha protegido pela fé e dás força divina aos teus aliados.',
        'Circle of the Land': 'Guardas locais antigos e lanças magia poderosa alimentada pelas regiões que proteges.',
        'Circle of the Moon': 'Libertas a besta interior, transformando-te em criaturas ferozes que dilaceram inimigos.',
        'Circle of the Sea': 'Comandas o poder dos oceanos, criando tempestades e ondas que esmagam adversários.',
        'Circle of Stars': 'Guias-te por padrões celestes, assumindo formas radiantes e moldando o destino com magia estelar.',
        'Battle Master': 'Controlas o campo com manobras táticas e lideras aliados como um general veterano.',
        'Champion': 'Ultrapassas os limites físicos, acertando golpes críticos com frequência.',
        'Eldritch Knight': 'Fundes combate e magia, teleportando-te e lançando fogo com a tua lâmina encantada.',
        'Psi Warrior': 'Transformas a mente em arma, empurrando e defendendo-te com pura força psíquica.',
        Dungeoneer: 'Conheces cada armadilha e guia-te por superstições, sobrevivendo onde outros caem.',
        'Way of Mercy': 'Alternas entre curar e punir, tocando para sarar ou para causar dor.',
        'Way of Shadow': 'Atacas das trevas e desapareces em fumo, um verdadeiro fantasma silencioso.',
        'Way of the Elements': 'Dominas fogo, água, ar e terra com o ki, libertando rajadas elementais.',
        'Way of the Open Hand': 'Derrubas e empurras inimigos com golpes de precisão impecável.',
        'Warrior of the Street': 'Lutas como num videojogo, com combos rápidos e uppercuts de energia.',
        'Oath of Devotion': 'Juraste justiça e luz, esmagando o mal com força radiante.',
        'Oath of Glory': 'Brilhas como herói mítico e inspiras feitos épicos nos aliados.',
        'Oath of the Ancients': 'Ligado à natureza e alegria, proteges a vida com energia férica.',
        'Oath of Vengeance': 'Persegues incansavelmente os malfeitores, prendendo e castigando sem piedade.',
        'Oath of Revelry': 'Vives para a festa, curando com brindes e animando todos à volta.',
        'Beast Master': 'Combates lado a lado com um companheiro animal, coordenando ataques selvagens.',
        'Fey Wanderer': 'Carregas a magia do Feywild e moves-te como um trickster entre dois mundos.',
        'Gloom Stalker': 'Caças na escuridão, movendo-te invisível e abatendo inimigos antes que te vejam.',
        Hunter: 'Adaptas-te para eliminar a presa escolhida com eficiência implacável.',
        'Arcane Trickster': 'Misturas ilusões e encantamentos aos ataques furtivos para enganar os inimigos.',
        Assassin: 'Perfeccionas o ataque surpresa, eliminando alvos de forma rápida e silenciosa.',
        Soulknife: 'Materializas lâminas psíquicas e saltas entre mentes para matar sem ruído.',
        Thief: 'Escalas, destrancas e roubas tesouros sem seres notado.',
        'Arachnoid Stalker': 'Usas poderes de aranha para trepar, disparar teias e envenenar as presas.',
        'Aberrant Sorcery': 'A tua magia alienígena liberta força psiónica e habilidades bizarras.',
        'Clockwork Sorcery': 'Representas a ordem cósmica, anulando caos com precisão relojoeira.',
        'Draconic Sorcery': 'Manifestas escamas e sopros elementais, tornando-te realeza dracónica.',
        'Wild Magic': 'Libertas surtos imprevisíveis que podem virar qualquer combate.',
        'Archfey Patron': 'Enfeitiças e confundes com truques feéricos, surgindo em névoa cintilante.',
        'Celestial Patron': 'Trazes luz e cura, queimando inimigos com fogo divino.',
        'Fiend Patron': 'Lanças chamas infernais e drenas vida dos derrotados.',
        'Great Old One Patron': 'Tocas a loucura cósmica, lendo pensamentos e enlouquecendo adversários.',
        'Future You': 'O teu eu do futuro guia o destino, manipulando tempo e causando dano com paradoxos.',
        Abjurer: 'Ergues barreiras e expulsas ameaças com mestria defensiva.',
        Diviner: 'Prevês o futuro e manipulas resultados com presságios certeiros.',
        Evoker: 'Transformas energia pura em explosões devastadoras.',
        Illusionist: 'Distorces a percepção com imagens tão reais que enganam até dragões.'
      },
    en: {

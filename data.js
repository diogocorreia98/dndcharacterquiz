...
const nameMap = {
  pt: {
    ...
    subclasses: {
      'Path of the Berserker': 'do Caminho do Berserker',
      ...
      'College of Glamour': 'do Colégio do Deslumbramento',
      ...
      'Psi Warrior': 'Cavaleiro Psiónico',
      Dungeoneer: 'Explorador de Masmorras',
      'Way of the Open Hand': 'do Caminho da Mão Aberta',
      'Way of Shadow': 'do Caminho da Sombra',
      'Way of the Elements': 'do Caminho dos Elementos',
      'Way of Mercy': 'do Caminho da Misericórdia',
      ...
      'Gloom Stalker': 'das Sombras',
      'Hunter': 'Caçador',
      'Arachnoid Stalker': 'Aracnídeo',
